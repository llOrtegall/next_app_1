    ...
    <form className='max-w-xl mx-auto flex gap-4'>
      <div className='grow pt-8'>
        ...
        <div className='mt-4'>
          ...
          <button className='w-full flex items-center gap-1 py-1 justify-center border rounded border-gray-400 text-gray-600  mb-2 font-semibold'>
            <FontAwesomeIcon icon={faLocationCrosshairs} className='h-4 mr-2'/>
            <span>Share current location</span>
          </button>
          <div className='bg-gray-200 p-4 min-h-12 rounded text-gray-600'>
            google maps here
          </div>
        </div>
      </div>
